...
def train(dataset="shakespeare_char", out_dir="run_0", seed_offset=0):
    ...
    max_iters = 1000 if dataset == "shakespeare_char" else 20000
    weight_decay = 1e-1
    beta1 = 0.9
    ...
    compile = False  # 在 Mac 上禁用编译以避免问题
